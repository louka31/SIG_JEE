			...
			<div class="main-content">
				<div class="content-wrapper">
					...
					<section id="basic-form-layouts">
						<div class="row">
							<div class="col-sm-12">
								<div class="content-header">Modifier Image</div>
							</div>
						</div>
									...
									<div class="card-body">
										<div class="px-3">
											<%
												...
												Image u = ls.getImage(request.getParameter("id"));
											%>
											<form class="form form-horizontal form-bordered"
												action="ModImageServlet" method="post">
												<div class="form-body">
													<h4 class="form-section">
														<i class="ft-info"></i> Informations Image
													</h4>
													<div class="row">
														<div class="col-md-10">
															<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Enregistrement
																</label>
																<div class="col-md-9">
																	<input type="text" value="<%=u.getEnregistrement()%>"
																		name="enregistrement" id="userinput1"
																		class="form-control border-primary" placeholder="Enreg " required  pattern="[A-Za-z]{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques">
																																			<input name="id" type="hidden" value="<%=u.getId()%>">
																		
																</div>
															</div>
																<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Top
																</label>
																<div class="col-md-9">
																	<input type="text" value="<%=u.getTop()%>"
																		name="top" id="userinput1"
																		class="form-control border-primary" placeholder="Top" type="number" step="0.01">
																</div>
															</div>
																			<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Bottom
																</label>
																<div class="col-md-9">
																	<input type="text" value="<%=u.getBottom()%>"
																		name="bottom" id="userinput1"
																		class="form-control border-primary" placeholder="Bottom" type="number" step="0.01">
																</div>
															</div>

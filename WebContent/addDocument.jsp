...
<section id="basic-form-layouts">
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Nouvelle Document</div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="px-3">
            <form class="form form-horizontal form-bordered" action="DocumentServlet" method="post">
              <div class="form-body">
                <h4 class="form-section"><i class="ft-info"></i> Informations Document</h4>
                <div class="row">
                  <div class="col-md-10">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="nom" id="userinput1" class="form-control border-primary" placeholder="Nom" required  pattern="[A-Za-z0-9]{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques"
                         >
                      </div>
                    </div>
                     <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Sigle</label>
                      <div class="col-md-9">
                        <input type="text" name="sigle" id="userinput1" class="form-control border-primary" placeholder="Sigle " required required  pattern="[A-Za-z0-9]{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques"
                         >
                      </div>
                    </div>
                      ...
                      <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Numéro document</label>
                      <div class="col-md-9">
                        <input type="number" name="numdoc" id="userinput1" class="form-control border-primary" placeholder="Numero document" required 
                         >
                      </div>
                    </div>
                      
                        <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">TD Formation</label>
                      <div class="col-md-9">
                        <input type="number" name="tdformation"step="0.0000001" id="userinput1" class="form-control border-primary" placeholder="TD Formation " required 
                         >
                      </div>
                    </div>
                    
                      <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">TD m</label>
                      <div class="col-md-9">
                        <input type="number" name="tdm" id="userinput1"step="0.0000001" class="form-control border-primary" placeholder="Td m" required 
                         >
                      </div>
                    </div>
                   ...
                   <div class="form-group row">
																...
																<div class="col-md-9">
																	<%
																	FormatService cs = new FormatService();

																		List<Format> ccs = cs.getListOfFormat();
%>

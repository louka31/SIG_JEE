			...
			<div class="main-content">
				<div class="content-wrapper">
					...
					<section id="basic-form-layouts">
						<div class="row">
							<div class="col-sm-12">
								<div class="content-header">Modifier Permis</div>
							</div>
						</div>
								...
								<div class="card">
									...
									<div class="card-body">
										<div class="px-3">
											...
											Permis u = ls.getPermis(request.getParameter("id"));
											%>
											<form class="form form-horizontal form-bordered"
												action="ModPermisServlet" method="post">
												<div class="form-body">
													<h4 class="form-section">
														<i class="ft-info"></i> Informations Permis
													</h4>
													<div class="row">
														<div class="col-md-6">
															<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Ancien Nom
																</label>
																<div class="col-md-9">
																	<input type="text" value="<%=u.getAncien_nom()%>"
																		name="ancien_nom" id="userinput1"
																		class="form-control border-primary" placeholder="Nom " required  pattern="{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques">
																																			<input name="id" type="hidden" value="<%=u.getId()%>">
																																																					<input name="idprojet" type="hidden" value="<%=u.getIdprojet()%>">
																		
																</div>
															</div>
																<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Nouveau Nom
																</label>
																<div class="col-md-9">
																	<input type="text" value="<%=u.getNouveau_nom()%>"
																		name="nouveau_nom" id="userinput1"
																		class="form-control border-primary" placeholder="Nom " required  pattern="{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques">
																</div>
															</div>

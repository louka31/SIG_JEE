                ...
                <div class="row">
                  <div class="col-md-10">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="enregistrement" id="userinput1" class="form-control border-primary" placeholder="Enregistrement " required  pattern="[A-Za-z0-9]{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques"
                         >
                      </div>
                    </div>
                     <div class="form-group row">

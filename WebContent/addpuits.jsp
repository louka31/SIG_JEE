			...
			<div class="main-content">
				<div class="content-wrapper">
					...
					<section id="basic-form-layouts">
						<div class="row">
							<div class="col-sm-12">
								<div class="content-header">Nouvelle Puits</div>
							</div>
						</div>
									...
									<div class="card-body">
										<div class="px-3">
											<form class="form form-horizontal form-bordered"
												action="PuitsServlet" method="post">
												<div class="form-body">
													...
													<div class="row">
														<div class="col-md-10">
															...
															<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Numéro</label>
																<div class="col-md-9">
																	<input type="number" name="num" id="userinput1"
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" name="nom" id="userinput1"
																		class="form-control border-primary" placeholder="Nom "
																		required pattern="{4,30}"
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" name="sigle" id="userinput1"
																		class="form-control border-primary"
																		placeholder="Sigle" required pattern="{4,30}"
																		title="Le champs doit contenir au moins 4 lettres alphabétiques">
																</div>
															</div>
															...
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<%
																		...
																		List<Cordonnees> ccs = cs.allCCordonneess();
%>

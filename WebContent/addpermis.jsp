...
<section id="basic-form-layouts">
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Nouvelle permis</div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="px-3">
            <form class="form form-horizontal form-bordered" action="PermisServlet" method="post">
              <div class="form-body">
                <h4 class="form-section"><i class="ft-info"></i> Informations permis</h4>
                <div class="row">
                  <div class="col-md-10">
                 
                    <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Ancien Nom </label>
                      <div class="col-md-9">
                        <input type="text" name="ancien_nom" id="userinput1" class="form-control border-primary" placeholder="Ancien Nom "required  pattern="{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques"
                         >
                      </div>
                    </div>
                     <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Nouveau Nom</label>
                      <div class="col-md-9">
                        <input type="text" name="nouveau_nom" id="userinput1" class="form-control border-primary" placeholder="Nouveau Nom " required  pattern="{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques"
                         >
                      </div>
                    </div>
                     ...
                     <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Projet</label>
                      <div class="col-md-9">
                       <% ProjetService ps=new ProjetService();

List<Projet> pp=ps.getListOfProjetts();
%>

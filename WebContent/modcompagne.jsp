			...
			<div class="main-content">
				<div class="content-wrapper">
					...
					<section id="basic-form-layouts">
						<div class="row">
							<div class="col-sm-12">
								<div class="content-header">Modifier Compagne</div>
							</div>
						</div>
									...
									<div class="card-body">
										<div class="px-3">
											<%
												...
												Compagne u = ls.getCompagne(request.getParameter("id"));
											%>
											<form class="form form-horizontal form-bordered"
												action="ModCompagneServlet" method="post">
												<div class="form-body">
													<h4 class="form-section">
														<i class="ft-info"></i> Informations Compagne
													</h4>
													<div class="row">
														<div class="col-md-10">
															<div class="form-group row">
																...
																<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Telephone
																</label>
																<div class="col-md-9">
																	<input type="number" value="<%=u.getTelephone()%>"
																		name="Telephone" id="userinput1"
																		class="form-control border-primary" placeholder="Tel ">
																</div>
															</div>
																			<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Adresse
																</label>
																<div class="col-md-9">
																	<input type="text" value="<%=u.getAdresse()%>"
																		name="Adresse" id="userinput1"
																		class="form-control border-primary" placeholder="Adr " required  pattern="[A-Za-z]{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques">
																</div>
															</div>
																	<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Email
																</label>
																<div class="col-md-9">
																	<input type="text" value="<%=u.getEmail()%>"
																		name="Email" id="userinput1"

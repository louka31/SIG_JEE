...
<section id="basic-form-layouts">
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Nouveaux Projet</div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="px-20">
            <form class="form form-horizontal form-bordered" action="UserServlet" method="post">
              <div class="form-body">
                <h4 class="form-section"><i class="ft-info"></i> Information Utilisateur</h4>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Nom </label>
                      <div class="col-md-9">
                        <input type="text" name="nom" id="userinput1" class="form-control border-primary" placeholder="Nom " required    pattern="[A-Za-z]{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques"
                         >
                      </div>
                    </div>
                     <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Prenom</label>
                      <div class="col-md-9">
                        <input type="text" name="prenom" id="userinput1" class="form-control border-primary" placeholder="Prenom " required  pattern="[A-Za-z]{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques"
                         >
                      </div>
                    </div>
                      ...
                      <div class="col-md-9">
                        <input type="email" name="email" id="userinput1" class="form-control border-primary" placeholder="Email " required  
                         >
                      </div>
                    </div>
                    
                       <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Telephone</label>
                      <div class="col-md-9">
                        <input type="text" name="tel" id="userinput1" class="form-control border-primary" placeholder="Numero telephone " required  pattern="[0-9]{8}"  title="Le champs doit contenir 8  chiffres"
                         >
                      </div>
                    </div>
                    
                      		<div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Genre</label>
                      <div class="col-md-9">
...
<OPTION VALUE="Homme">Homme
                ...
                <h4 class="form-section"><i class="ft-mail"></i>Parametre de Connexion</h4>

               <div class="row">
                 
<div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Nom D'utilisateur</label>
                      <div class="col-md-9">
                        <input type="text" id="xmin" name="userId"  class="form-control border-primary" placeholder="Nom utilisateur" required  pattern="[A-Za-z0-9]{4,30}"  title="Le champs doit contenir au moins 4 chiffres ou lettres alphabétiques"
                          >
                      </div>
                    </div>
					 <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Mot De Passe</label>
                      <div class="col-md-9">
                        <input type="password" id="xmax" name="password"  class="form-control border-primary" placeholder="mot de passe" required  pattern="[A-Za-z0-9]{4,30}"  title="Le champs doit contenir au moins 4 chiffres ou lettres alphabétiques" 
                          >
                      </div>
                    </div>
...
<OPTION VALUE="Administrateur" SELECTED> Administrateur
<OPTION VALUE="Indexateur">Indexateur

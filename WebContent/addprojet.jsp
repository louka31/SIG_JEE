  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="px-3">
            <form class="form form-horizontal form-bordered" action="ProjetServlet" method="post">
              <div class="form-body">
                ...
                <div class="row">
                  <div class="col-md-10">
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="nom" id="userinput1" class="form-control border-primary" placeholder="Nom de Projet"
...
<div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" id="xmin" name="x_min" readonly class="form-control border-primary" placeholder="X MIN"
                          name="firstname" required>
                      </div>
                    </div>
					 <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" id="xmax" name="x_max" readonly class="form-control border-primary" placeholder="X MAX"
                          name="firstname">
                      </div>
                    </div>
					 <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" id="ymin" name="y_min" readonly class="form-control border-primary" placeholder="Y MIN"
                          name="firstname">
                      </div>
                    </div>
					 <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" readonly name="y_max"id="ymax" class="form-control border-primary" placeholder="Y MAX"
                          name="firstname">
                      </div>
                    </div>
                  </div>

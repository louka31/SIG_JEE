...
<%@page import="com.gcollecte.model.Projet"%><%@page import="com.gcollecte.model.Format"%>
<%@page import="java.util.List"%>

<%@page import="com.gcollecte.service.FormatService"%><!DOCTYPE html>
			...
			<div class="main-content">
				<div class="content-wrapper">
					...
					<section id="basic-form-layouts">
						<div class="row">
							<div class="col-sm-12">
								<div class="content-header">Modifier Document</div>
							</div>
						</div>
									...
									<div class="card-body">
										<div class="px-3">
											<%
												...
												Document u = ls.getDocument(request.getParameter("id"));
											%>
											<form class="form form-horizontal form-bordered"
												action="ModDocumentServlet" method="post">
												<div class="form-body">
													<h4 class="form-section">
														<i class="ft-info"></i> Informations Document
													</h4>
													<div class="row">
														<div class="col-md-10">
															<div class="form-group row">
																...
																<div class="col-md-9">
																	<input type="text" value="<%=u.getNom()%>"		name="nom" id="userinput1"
															...
															<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">Numéro document
																</label>
																<div class="col-md-9">
																	<input type="text" value="<%=u.getNum_doc()%>"
																		name="numdoc" id="userinput1"
																		class="form-control border-primary" placeholder="num doc">
																</div>
															</div>
															
															<div class="form-group row">
																<label class="col-md-3 label-control" for="userinput1">TD formation 
																</label>
																<div class="col-md-9">
																	<input type="text" value="<%=u.getTd_formation()%>"
																		name="tdformation" id="userinput1"
																		class="form-control border-primary" placeholder="TD formation" type="number" step="0.01">
																</div>
															</div>

...
<section id="basic-form-layouts">
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Nouvelles Cordonnees</div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="px-3">
            <form class="form form-horizontal form-bordered" action="CordonneesServlet" method="post">
              <div class="form-body">
                <h4 class="form-section"><i class="ft-info"></i> Information Cordonnees</h4>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-md-3 label-control" for="Cordonneesinput1">X(m) </label>
                      <div class="col-md-9">
                        <input type="number" step="0.0000001" name="x_m" id="Cordonneesinput1" class="form-control border-primary" placeholder="X(m) " required title="le champs doit contenir un réel"
                         >
                      </div>
                    </div>
                     <div class="form-group row">
                      <label class="col-md-3 label-control" for="Cordonneesinput1">Y(m)</label>
                      <div class="col-md-9">
                        <input type="number" step="0.00000001" name="y_m" id="Cordonneesinput1" class="form-control border-primary" placeholder="Y(m)" required title="le champs doit contenir un réel"
                         >
                      </div>
                    </div>
                      <div class="form-group row">
                      <label class="col-md-3 label-control" for="Cordonneesinput1">X degré </label>
                      <div class="col-md-9">
                        <input type="text" name="x_deg" id="Cordonneesinput1" class="form-control border-primary" placeholder="X degré" required  title="le champs doit contenir un réel"
                         >
                      </div>
                    </div>
                      <div class="form-group row">
                      <label class="col-md-3 label-control" for="Cordonneesinput1">Y degré </label>
                      <div class="col-md-9">
                        <input type="text" name="y_deg" id="Cordonneesinput1" class="form-control border-primary" placeholder="Y degré" required  title="le champs doit contenir un réel"
                         >
                      </div>
                    </div>
                  </div>

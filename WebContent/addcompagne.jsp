...
<section id="basic-form-layouts">
  <div class="row">
    <div class="col-sm-12">
      <div class="content-header">Nouvelle compagnie</div>
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="card">
        ...
        <div class="card-body">
          <div class="px-3">
            <form class="form form-horizontal form-bordered" action="CompagneServlet" method="post">
              <div class="form-body">
                <h4 class="form-section"><i class="ft-info"></i> Informations Compagnie</h4>
                <div class="row">
                  <div class="col-md-8">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="nom" id="userinput1" class="form-control border-primary" placeholder="Nom " required  pattern="{4,30}"  title="Le champs doit contenir au moins 4 lettres alphabétiques"
                         >
                      </div>
                    </div>
                     <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="email" name="email" id="userinput1" class="form-control border-primary" placeholder="Email " required  pattern="[A-Za-z0-9](([_\.\-]?[a-zA-Z0-9]+)*)@([A-Za-z0-9]+)(([_\.\-]?[a-zA-Z0-9]+)*)\.([A-Za-z]{2,})" title="Adresse e-mail au format contact@montrezvous.net"
                         >
                      </div>
                    </div>
                        <div class="form-group row">
                      ...
                      <div class="col-md-9">
                        <input type="text" name="telephone" id="userinput1" class="form-control border-primary" placeholder="Telephone "required pattern="[0-9]{8}" title="Le champs doit contenir  8 chiffres"
                        
                         >
                      </div>
                    </div>
                        <div class="form-group row">
                      <label class="col-md-3 label-control" for="userinput1">Adresse</label>
                      <div class="col-md-9">
                        <input type="text" name="adresse" id="userinput1" class="form-control border-primary" placeholder="Adresse " required 
                         >
                      </div>
                    </div>
                  </div>
